...
getUserEmail, getOTPData, deleteOTP, createNewOTP, modifyUserPassword, getUsers, createNewProcedure, getLastIDPrcedure, getProcedures, deleteAppointment} from '../database/db.js';
...
app.post('/institution_add', async(req, res) => {
  ...
  try {
    ...
    res.status(500).json({message: 'Corroboración'})
  }
});
