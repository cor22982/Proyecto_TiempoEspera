...
export async function register(pi,name, lastname,password_md5,birthdate,type_user) {
  ...
  const result = await conn.query('INSERT INTO users (pi, name, lastname, password, birthdate, type_user, perfi_image) VALUES ($1, $2, $3, $4, $5, $6, decode($7, "base64"));', [pi, name, lastname, password_md5, birthdate, type_user, imagen_base64]);
